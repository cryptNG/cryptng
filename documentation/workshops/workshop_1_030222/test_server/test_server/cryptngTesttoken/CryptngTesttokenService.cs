...
namespace CryptNG.Autogen.cryptngTesttoken
{
    public partial class CryptngTesttokenService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, CryptngTesttokenDeployment cryptngTesttokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<CryptngTesttokenDeployment>().SendRequestAndWaitForReceiptAsync(cryptngTesttokenDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, CryptngTesttokenDeployment cryptngTesttokenDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<CryptngTesttokenDeployment>().SendRequestAsync(cryptngTesttokenDeployment);
        }

        public static async Task<CryptngTesttokenService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, CryptngTesttokenDeployment cryptngTesttokenDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, cryptngTesttokenDeployment, cancellationTokenSource);
            return new CryptngTesttokenService(web3, receipt.ContractAddress);
        }
        ...
        public CryptngTesttokenService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
