 ...
 * {ERC721Enumerable}.
 */
contract cryptngTesttoken is Context, ERC165, IERC721, IERC721Metadata, Ownable {
 ...
 constructor(){
  ...
  function _getTokenWithEnoughBalance(address _sender) private view returns (int)
    ...
    function _transfer(
        ...
        require(cryptngTesttoken.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
