...
namespace CryptNG.Autogen.ComputingPaymentToken.ContractDefinition
{


    public partial class ComputingPaymentTokenDeployment : ComputingPaymentTokenDeploymentBase
    {
        public ComputingPaymentTokenDeployment() : base(BYTECODE) { }
        public ComputingPaymentTokenDeployment(string byteCode) : base(byteCode) { }
    }

    public class ComputingPaymentTokenDeploymentBase : ContractDeploymentMessage
    {
        public static string BYTECODE = "";
        public ComputingPaymentTokenDeploymentBase() : base(BYTECODE) { }
        public ComputingPaymentTokenDeploymentBase(string byteCode) : base(byteCode) { }
