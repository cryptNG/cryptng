 ...
 * {ERC721Enumerable}.
 */
contract ComputingPaymentToken is
    Context,
    ERC165,
    IERC721,
    IERC721Metadata,
    Ownable
{
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ComputingPaymentToken.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(
            ComputingPaymentToken.ownerOf(tokenId) == from,
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ComputingPaymentToken.ownerOf(tokenId), to, tokenId);
    }
