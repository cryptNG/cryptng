...
//THIS CONTRACT ONLY CONTAINS EXISTING ERC INTERFACES
...
//let instance = await ComputingPaymentToken.deployed()
//instance.method();

//eg: instance.mint(0,'0x4b24112d41ddc8c4cd68d5e84c065d8227946d4a',{value:10000001000000000});
 ...
 * {ERC721Enumerable}.
 */
contract ComputingPaymentTokenERC721 is
    Context,
    ERC165,
    IERC721,
    IERC721Metadata,
...
// beispiel
// owner[0] = 0xAAAA (owneraddress)
// ttype[0] = 01  (tokentype)

// owner[1000] = 0xAAAA (owneraddress)
// ttype[1000] = 1  (tokentype)
// owner[1001] = 0xAAAA (owneraddress)
// ttype[1001] = 2  (tokentype)

// 100000000000000000000
// 100000000000000001000
// 200000000000000001001

// idx + t *100000000000000000000=tid

// floor(tid /100000000000000000000)=t
// tid-t*100000000000000000000=idx


// 200000000000000001001 / 100000000000000000000
// = 2 * 100000000000000000000
// = 200000000000000001001 - 200000000000000000000 = 1001

    // Mapping from token ID to owner address
    address[] internal _owners;
    uint16[] internal _types;

    uint16 _maxTypes = 2;

    uint internal _maxTokens = 100000000000; 
    ...
    function getTypeIdFromTokenId(uint tokenId) internal view returns (uint16){
    ...
    function getTokens(address owner) public view returns (uint256[] memory) {
        ...
        for (uint256 i = 0; i < _owners.length; i++) {
            if (_owners[i] == owner) {
                ...
                tokens[tokenlistpos] = i + _types[i]*_maxTokens;
                tokenlistpos++;
            }
        }
        return tokens;
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ComputingPaymentTokenERC721.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(
            ComputingPaymentTokenERC721.ownerOf(tokenId) == from,
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ComputingPaymentTokenERC721.ownerOf(tokenId), to, tokenId);
    }
