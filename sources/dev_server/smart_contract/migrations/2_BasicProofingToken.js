...
module.exports = function (deployer) {
   ...
   try
   {
      ...
      fs.readFile('build/contracts/BasicProofingToken.json', 'utf8', function (err,tokenfile) {
        if (err) {
          return console.log(err);
        }
      ...
      fs.writeFile('/root/sources/cryptng/sources/dev_client/service_client_example/BasicProofingToken.abi', tokenAbi, 'utf8', function (err) {
